...
class SatelliteObservationResponse(BaseModel):
    ...
    nasa_gibs_url: Optional[str] = Field(None, example="https://gibs.earthdata.nasa.gov/wmts/epsg3857/best/VIIRS_SNPP_CorrectedReflectance_TrueColor/default/default/GoogleMapsCompatible_Level9/{z}/{y}/{x}.jpg")
